...
void Button_init(void)
{
    ...
    GPIOPinTypeGPIOInput(GPIO_PORT_BUTTON, GPIO_PIN_BUTTON_RIGHT | GPIO_PIN_BUTTON_LEFT);
    GPIOPadConfigSet(GPIO_PORT_BUTTON, GPIO_PIN_BUTTON_RIGHT | GPIO_PIN_BUTTON_LEFT, GPIO_STRENGTH_8MA_SC, GPIO_PIN_TYPE_STD_WPU);

    GPIOIntTypeSet(GPIO_PORT_BUTTON, GPIO_PIN_BUTTON_RIGHT | GPIO_PIN_BUTTON_LEFT, GPIO_FALLING_EDGE);
	GPIOIntRegister(GPIO_PORT_BUTTON, &ButtonsISR);
	IntEnable(INT_BUTTON);
...
static void ButtonDebounceCallback(void)
{
	...
	{
		if (GPIOPinRead(GPIO_PORT_BUTTON, GPIO_PIN_BUTTON_RIGHT) == 0)
		{
	...
	{
		if (GPIOPinRead(GPIO_PORT_BUTTON, GPIO_PIN_BUTTON_LEFT) == 0)
		{
